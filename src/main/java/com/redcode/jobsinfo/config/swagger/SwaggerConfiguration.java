package com.redcode.jobsinfo.config.swagger;
...
public class SwaggerConfiguration {
     ...
     */
    @Bean
    public Docket swaggerSpringfoxDocket(RedcodeProperties properties) {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.redcode.jobsinfo.web.rest"))
                .build()
                .tags(new Tag("JobsInfo", "All apis related to JobsInfo."));
        watch.stop();
