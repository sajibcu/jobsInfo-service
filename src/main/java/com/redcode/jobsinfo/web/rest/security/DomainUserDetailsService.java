...
import com.redcode.jobsinfo.common.exceptions.UserNotActivatedException;
...
public class DomainUserDetailsService implements UserDetailsService {
    ...
    public DomainUserDetailsService(UserRepository userRepository, @Value("${redcode.admin.email}") String adminEmail) {
    ...
    private org.springframework.security.core.userdetails.User createSpringSecurityUser(String lowercaseLogin, User user) {
        ...
        if (user.getUserType().getId() == 1) { // role 1 is admin and other is normal user
